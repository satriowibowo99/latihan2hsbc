const listQuestions = [
    ...
    {
      correct: 0,
      answer: [ 'Harvard', 'University of Washington', 'Yale', 'Oxford' ],
    ...
    {
      correct: 0,
      answer: [ '14th November', '11th December', '15th October', '1st July' ],
      question: "When is the World's Diabetes Day?"
    },
    {
      correct: 0,
      answer: [ 'Kelvin', 'Celsius', 'Centigrade', 'Fahrenheit' ],
    ...
    {
      correct: 0,
      answer: [ 'New York, USA', 'Haque (Netherlands)', 'Geneva', 'Paris' ],
    ...
    {
      correct: 1,
      answer: [ 'Guruji', 'Man of Peace', 'Punjab Kesari', 'Mahamana' ],
    ...
    },
    {
      ...
      answer: [ 'Potato chips', 'Fine wines', 'Chewing gum', 'Baby Food' ],
      correct: 3
    },
    {
    ...
    {
      correct: 3,
      answer: [ 'Nagaland', 'Arunachal Pradesh', 'Assam', 'All of the above' ],
      question: 'Guwahati High Court is the judicature of'
    },
    {
      correct: 0,
      answer: [ 'Orissa', 'Tamil nadu', 'Andhra Pradesh', 'Kerala' ],
    ...
    {
      correct: 2,
      answer: [ '1789 AD', '1798 AD', '1792 AD', '1729 AD' ],
    ...
    {
      correct: 0,
      answer: [ 'coins', 'numbers', 'stamps', 'space' ],
    ...
    },
    {
      ...
      answer: [ '8.3" x 11.7"', '8.5" x 11"', '30cm x 50cm', '8.5" x 14"' ],
      correct: 0
    },
    {
      correct: 2,
      answer: [ 'energy', 'speed', 'distance', 'intensity' ],
    ...
    {
      correct: 2,
      answer: [ 'Ethiopia', 'Nigeria', 'Zambia', 'Chad' ],
...
const asnwerD = document.getElementById('answerD');
let currentLevel = document.getElementById('case'+level)


function displayQuestion () {
  const randomNumber = Math.floor(Math.random()*listQuestions.length);
  const question = listQuestions.splice(randomNumber,1)

  currentLevel.classList.remove('bg-purple-500')
  currentLevel.style.backgroundColor = 'pink'

  selectedRandomQuestion = question;
  questionText.innerHTML=question[0].question
  answerA.innerHTML='A. '+question[0].answer[0]
  answerB.innerHTML='B. '+question[0].answer[1]
  answerC.innerHTML='C. '+question[0].answer[2]
  asnwerD.innerHTML='D. '+question[0].answer[3]

  correctAnswer = question[0].correct
...
async function checkAnswer(selectedOption, option) {
  const selectedTag = 'jawaban'+option
  console.log(selectedTag);
  const jawabanTag = document.getElementById(selectedTag);
  
  const selectedLevel = 'case'+level
  const scoreTag = document.getElementById(selectedLevel)

  jawabanTag.classList.remove('bg-purple-500')
  jawabanTag.style.backgroundColor = 'yellow'

  await delay(2000);

  if(selectedOption === selectedRandomQuestion[0].answer[correctAnswer]) {
    jawabanTag.style.backgroundColor = 'green'
    level++
    currentLevel = document.getElementById('case'+level)
    await delay(1000)
    displayQuestion()
    jawabanTag.style.backgroundColor = '#A500FF'
  } else {
    jawabanTag.style.backgroundColor = 'red'
    await delay(1000)
...
answerA.addEventListener("click", function() {
  const selectedOption = selectedRandomQuestion[0].answer[0];
  checkAnswer(selectedOption, 'A');
});

answerB.addEventListener("click", function() {
  const selectedOption = selectedRandomQuestion[0].answer[1];
  checkAnswer(selectedOption, 'B');
});

answerC.addEventListener("click", function() {
  const selectedOption = selectedRandomQuestion[0].answer[2];
  checkAnswer(selectedOption, 'C');
});

asnwerD.addEventListener("click", function() {
  const selectedOption = selectedRandomQuestion[0].answer[3];
  checkAnswer(selectedOption, 'D');
});
